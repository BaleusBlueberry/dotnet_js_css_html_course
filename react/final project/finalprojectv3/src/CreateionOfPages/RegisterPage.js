      ...
      <form onSubmit={handleSubmit}>
        ...
        <Dropdown data-bs-theme={theme}>
          <Dropdown.Toggle variant="success" id="isBusnies" className="mb-3">
            {registerData.isBusiness ? "Is a Busines" : "Not a Busines"}
          </Dropdown.Toggle>
          <Dropdown.Menu>
            <Dropdown.Item
              onClick={() =>
                setRegisterData({ ...registerData, isBusiness: false })
              }
            >
              Not a Busines
            </Dropdown.Item>
            <Dropdown.Item
              onClick={() =>
                setRegisterData({ ...registerData, isBusiness: true })
              }
            >
              Is a Busines
            </Dropdown.Item>
